...
public:
  ...
  void setOperationalSpeed() {
    stepper1.setMaxSpeed(STEP * 15 * resolution);
    stepper2.setMaxSpeed(STEP * 15 * resolution);
    stepper1.setAcceleration(STEP * 15 * resolution);
    stepper2.setAcceleration(STEP * 15 * resolution);
  }
