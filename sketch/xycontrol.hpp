...
public:
  ...
  void setOperationalSpeed() {
    stepper1.setMaxSpeed(STEP * 6.0 * resolution);
    stepper2.setMaxSpeed(STEP * 6.0 * resolution);
    stepper1.setAcceleration(STEP * 4.0 * resolution);
    stepper2.setAcceleration(STEP * 4.0 * resolution);
  }
