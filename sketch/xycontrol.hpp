...
public:
  ...
  void setOperationalSpeed() {
    stepper1.setMaxSpeed(STEP * 5.0 * resolution);
    stepper2.setMaxSpeed(STEP * 5.0 * resolution);
    stepper1.setAcceleration(STEP * 8.0 * resolution);
    stepper2.setAcceleration(STEP * 8.0 * resolution);
  }
